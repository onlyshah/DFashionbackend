...
const defineRole = require('../models_sql/Role');
const defineDepartment = require('../models_sql/Department');
const defineUser = require('../models_sql/User');
const defineBrand = require('../models_sql/Brand');
const defineCategory = require('../models_sql/Category');
const defineSubCategory = require('../models_sql/SubCategory');
...
const defineModule = require('../models_sql/Module');
const defineRolePermission = require('../models_sql/RolePermission');
const defineSession = require('../models_sql/Session');
const defineCart = require('../models_sql/Cart');
const defineWishlist = require('../models_sql/Wishlist');
const defineOrder = require('../models_sql/Order');
const definePayment = require('../models_sql/Payment');
const defineReturn = require('../models_sql/Return');
const defineCourier = require('../models_sql/Courier');
const defineShipment = require('../models_sql/Shipment');
const defineShippingCharge = require('../models_sql/ShippingCharge');
const defineCoupon = require('../models_sql/Coupon');
const defineFlashSale = require('../models_sql/FlashSale');
const defineCampaign = require('../models_sql/Campaign');
const definePromotion = require('../models_sql/Promotion');
const defineNotification = require('../models_sql/Notification');
const defineReward = require('../models_sql/Reward');
const definePage = require('../models_sql/Page');
const defineBanner = require('../models_sql/Banner');
const defineFAQ = require('../models_sql/FAQ');
const defineKYCDocument = require('../models_sql/KYCDocument');
const defineSellerCommission = require('../models_sql/SellerCommission');
const defineSellerPerformance = require('../models_sql/SellerPerformance');
const defineProductShare = require('../models_sql/ProductShare');
const defineSearchHistory = require('../models_sql/SearchHistory');
const defineSearchSuggestion = require('../models_sql/SearchSuggestion');
const defineTrendingSearch = require('../models_sql/TrendingSearch');
const defineLiveStream = require('../models_sql/LiveStream');
const defineAuditLog = require('../models_sql/AuditLog');
const defineTransaction = require('../models_sql/Transaction');
const defineTicket = require('../models_sql/Ticket');
const defineQuickAction = require('../models_sql/QuickAction');
const defineStyleInspiration = require('../models_sql/StyleInspiration');
const defineWarehouse = require('../models_sql/Warehouse');
const defineSupplier = require('../models_sql/Supplier');
