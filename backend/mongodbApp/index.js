...
console.log('🚀 Starting DFashion MongoDB Backend...');
...
(async () => {
  try {
    // For MongoDB, just mark as ready since models are stub
    modelsReady = true;
...
app.get('/', (req, res) => {
  res.json({
    success: true,
    message: 'DFashion MongoDB Backend Running',
    database: 'MongoDB'
  });
});
...
const startServer = async () => {
  try {
    ...
    server.listen(PORT, () => {
      console.log(`\n🎉 DFashion MongoDB Backend listening on port ${PORT}`);
