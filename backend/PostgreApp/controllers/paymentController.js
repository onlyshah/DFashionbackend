/**
 * ============================================================================
 * PAYMENT CONTROLLER - PostgreSQL/Sequelize Version
 * ============================================================================
...
exports.getPaymentDetails = async (req, res) => {
  try {
    ...
    const payment = await models.Payment.findByPk(payment_id, {
      include: [
        { model: models.Order, attributes: ['id', 'order_number', 'total_amount'] },
...
/**
 * Process refund (alias for refund)
 */
exports.processRefund = async (req, res) => {
  return exports.refund(req, res);
};
